...
#ifndef __HCCL_ALLGATHERV_ROOTINFO_TEST_H_
#define __HCCL_ALLGATHERV_ROOTINFO_TEST_H_
#include "hccl_test_common.h"
#include "mpi.h"
#include "hccl_check_common.h"
#include "hccl_opbase_rootinfo_base.h"
namespace hccl {
class HcclOpBaseAllgatherVTest:public HcclOpBaseTest
{
public:
    HcclOpBaseAllgatherVTest();
    virtual ~HcclOpBaseAllgatherVTest();
